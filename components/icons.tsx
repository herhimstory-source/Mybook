...
export const StarIcon = ({ className = "w-6 h-6", filled = false }: { className?: string, filled?: boolean }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`${className} ${filled ? 'text-amber-400' : 'text-gray-300 dark:text-gray-600'}`} fill={filled ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={filled ? 0 : 2}>
...
export const SparklesIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414l-2.293 2.293m-1.414-4L12 3m0 0l-2.293 2.293a1 1 0 000 1.414L12 9m0-6v6m-6 4a1 1 0 011-1h4a1 1 0 110 2H6a1 1 0 01-1-1zm10 0a1 1 0 011-1h4a1 1 0 110 2h-4a1 1 0 01-1-1z" />
    </svg>
);
